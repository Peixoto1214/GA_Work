...
let thePlanets = ['mars', 'earth', 'saturn', 'jupiter', 'uranus', 'venus', 'neptune', 'mercury', 'pluto']
...
thePlanets.push('nibiru');
thePlanets.push('tatooine');

// Print your new array to the dom
document.querySelector('#exercise-two').textContent = thePlanets.join(' and ')
...
for(let foods = 0; foods < snacks.length; foods++ ){
  console.log(foods + ". " + snacks[foods])
//console.log(snacks[foods]);
